 ...
 * (brand-expert > industry-expert > verified-creator > top-contributor > moderator)
 * first.
 */
const ORDER = ["brand-expert", "industry-expert", "verified-creator", "moderator", "top-contributor"];

export function BadgeRow({ badges, brand, size = "default", limit }) {
